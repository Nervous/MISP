...
<div id="filter_screenshots" title="Only show screenshots" class="attribute_filter_text<?php if ($attributeFilter == 'screenshot') echo '_active'; ?>" onClick="filterAttributes('screenshot', '<?php echo h($event['Event']['id']); ?>');">Screenshots</div>
